...
ax1 = vix_v_10y['VIX Price'].plot(kind='line')
ax2 = vix_v_10y['10-Year Treasury Yield'].plot(kind='line', secondary_y = True)
ax1.set_xlabel('Date', fontweight='bold')
ax1.set_ylabel('VIX Price (in $US)', fontweight='bold')
...
plt.xlabel('VIX Price', fontweight='bold')
plt.ylabel('10-Year Treasury Yield', fontweight='bold')
